...
public class MoviePage {
    ...
    private By exploreUpcomingMoviesImgBy = By.xpath("//a//img[@alt='Coming Soon']");
    ...
    public void clickExploreUpcomingMovies() {
        WebElement element = WaitUtils.waitForClickability(driver, driver.findElement(exploreUpcomingMoviesImgBy));
        element.click();
    }
